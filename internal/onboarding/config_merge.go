...
func defaultStrategyObserveRegistry() []tomlUpdate {
	return []tomlUpdate{
		...
		{Path: []string{"risk_management", "risk_per_trade_pct"}, Value: "0.1"},
		{Path: []string{"risk_management", "max_invest_pct"}, Value: "1"},
		{Path: []string{"risk_management", "max_leverage"}, Value: "10"},
		{Path: []string{"risk_management", "risk_strategy", "mode"}, Value: tomlQuoted("llm")},
