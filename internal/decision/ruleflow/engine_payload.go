...
func buildInputPayload(ctx context.Context, input Input) (string, error) {
	...
	payload := map[string]any{
		...
		"consensus": map[string]any{
			...
			"agent_indicator_confidence": input.AgentIndicator.MovementConfidence,
			"agent_structure_confidence": input.AgentStructure.MovementConfidence,
			"agent_mechanics_confidence": input.AgentMechanics.MovementConfidence,
