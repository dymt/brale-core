...
func buildRuleflowInput(symbol string, res SymbolResult, bind strategy.StrategyBinding, state fsm.PositionState, positionID string, exitConfirmCount int, buildPlan bool, comp features.CompressionResult, acct execution.AccountState, risk execution.RiskParams, inPos ruleflow.InPositionOutputs, position ruleflow.HardGuardPosition, scoreThreshold, confidenceThreshold float64) ruleflow.Input {
