...
function renderFlow(flow) {
  ...
  function formatFlowFieldKey(key) {
    ...
    const labels = {
      ...
      score: "评分",
      threshold: "阈值",
      // Defensive: this Gate config field may leak into mixed flow payloads.
      ...
      integrity: "完整性",
      // Defensive: nested semantic-signal payloads may surface this generic key.
      value: "信号值",
      // Defensive: nested semantic-signal payloads may surface this generic key.
      confidence: "置信度",
      momentum_detail: "动量细节",
